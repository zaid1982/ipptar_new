...
mysql_select_db("$db_name")or die("cannot select DB");
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where costu_uid='$iduser'";
...
?>
	    ...
	    <table width="98%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td scope="col"><div align="center" class="style4">ID Kursus</div></td>
          ...
          <tr>
           ...
           <? 
						...
						$query_serfile = "SELECT costu_filename,costu_offerfile FROM costu_all where costu_appid='$tempfile'";
						$sercatfile=mysql_query($query_serfile);	
						$rows_sercatfile=mysql_fetch_array($sercatfile);
						$namefile=$rows_sercatfile['costu_offerfile'];
						$namefile2=$rows_sercatfile['costu_filename'];
						?>
            ...
            <td valign="top" scope="col"><table width="68" border="0" align="right" cellpadding="0" cellspacing="0">
              <tr>
			  <? if ($namefile!=''){?>
			    <td width="34" title="Muat Turun Surat Tawaran"><a href="../admincp/pdf/<? echo $namefile; ?>" target="_blank"><img src="tawaran.png" alt="Muat Turun Surat Tawaran" width="37" height="38" /></td>
				<? }?>
                <td width="34" title="Muat Turun Surat Pengesahan" ><a href="pdf/<? echo $namefile2; ?>" target="_blank"><img src="latter.png" alt="Muat Turun Surat Pengesahan" width="37" height="38" /></td>
                <td width="51"><a href="uviewstatus.php?idkur=<?=$data[costu_id]?>" class="buy" title="Maklumat Kursus"><img src="lanjut.png" width="37" height="38" border="0" /></a></td>
              </tr>
            </table></td>
            </tr>	<?
		}
