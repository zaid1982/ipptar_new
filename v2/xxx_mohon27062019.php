...
WHERE $cond01 $cond02 $cond03 a.b_id=b.k_bid AND (b.k_sdate > '$now' OR b.k_wlkin = '1')
ORDER BY a.b_id ASC
";
...
SELECT *
FROM kluster a, kursus b
WHERE $cond01 $cond02 $cond03 a.b_id=b.k_bid AND (b.k_sdate > '$now' OR b.k_wlkin = '1') AND b.k_sdate > '2018-10-31 00:00:00'
...
$condition = "WHERE $cond01 $cond02 $cond03 a.b_id=b.k_bid AND (b.k_sdate > '$now' OR b.k_wlkin = '1') AND b.k_sdate > '2018-10-31 00:00:00' ORDER BY b.k_sdate ASC,a.b_id ASC"; //If you have a condition write here
