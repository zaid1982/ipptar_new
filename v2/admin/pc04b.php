  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Task', 'Hours per Day'],
          ['1 - Amat Lemah', <?php print $j71 ?>],
          ['2 - Lemah', <?php print $j72 ?>],
          ['3 - Sederhana', <?php print $j73 ?>],
          ['4 - Baik', <?php print $j74 ?>],
          ['5 - Amat Baik', <?php print $j75 ?>]
        ]);

        var options = {
          title: 'Penekanan kepada teori',
          is3D: true,
        };

        var chart = new google.visualization.PieChart(document.getElementById('pc07'));
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Task', 'Hours per Day'],
          ['1 - Amat Lemah', <?php print $j81 ?>],
          ['2 - Lemah', <?php print $j82 ?>],
          ['3 - Sederhana', <?php print $j83 ?>],
          ['4 - Baik', <?php print $j84 ?>],
          ['5 - Amat Baik', <?php print $j85 ?>]
        ]);

        var options = {
          title: 'Penekanan kepada praktis',
          is3D: true,
        };

        var chart = new google.visualization.PieChart(document.getElementById('pc08'));
        chart.draw(data, options);
      }
    </script>
  </head>
  <body>
    <div id="pc07" style="width: 500px; height: 250px;"></div>
    <br/>
    <div id="pc08" style="width: 500px; height: 250px;"></div>
  </body>
</html>