...
<br/>
<br/>
<b>TAWARAN MENYERTAI KURSUS <?php print strtoupper($row['k_name']) ?> PADA <?php print strtoupper($k_sdate); ?>&nbsp;HINGGA&nbsp;<?php print strtoupper($k_edate); ?></b>
<br/>
<br/>
...
2. Sukacita dimaklumkan bahawa tuan/puan telah dipilih untuk menyertai kursus tersebut dan pendaftaran serta taklimat kursus akan diadakan pada tarikh dan tempat seperti berikut : <br><br>
...
<tr>
<td>
3. Kerjasama pihak tuan/puan adalah dipohon agar dapat mengemukakan yuran kursus sebanyak <b>RM<?php print $row['k_fee'] ?>.00</b> dan bayaran hendaklah dibuat <b>3 hari sebelum kursus bermula.</b><br/>
   Kaedah bayaran yuran kursus adalah seperti berikut: <br/>
<!-- Table untuk kaedah bayaran -->
<table width="90%" border="0" align="left" cellspacing="1">
<tr>
<ol>
<tr>
<td width="10%">&nbsp;</td>
<td> <li> Log masuk ke perbankan internet tuan/puan.</li></td>
</tr>
<tr> <td width="10%">&nbsp;</td>
<td> <li> Pilih opsyen bayaran bil dan cari Logo JomPAY.</li><td>
</tr>
<tr>
<td width="10%">&nbsp;</td>
<td> <li> Kunci Masuk Biller Code IPPTAR (wajib) : <b>278994</b> </li></td>
</tr>
<tr>
<td width="10%">&nbsp;</td>
<td> <li> Ref-1 (wajib): No. Kad Pengenalan </li></td>
</tr>
<tr>
<td width="10%">&nbsp;</td>
<td> <li> Ref-2 (wajib): Kod Kursus IPPTAR </li></td>
</tr>
<tr>
<td width="10%">&nbsp;</td>
<td><li> Masukkan jumlah bayaran dan sahkan pembayaran </li></td>
</tr>
<tr>
<td width="10%">&nbsp;</td>
<td><li >Sila simpan resit pembayaran untuk semakan IPPTAR </li></td>
</tr>
</ol>
</tr>
</table>

<!-- Tamat table kaedah bayaran -->
...
<tr>
<td>
4. <b>Peserta adalah diwajibkan untuk hadir sepenuh masa mengikut jadual kursus yang ditetapkan dan mematuhi etika pakaian penjawat awam semasa bertugas. Taklimat peraturan berkursus akan dimaklumkan pada hari pendaftaran dan sijil hanya akan dikeluarkan  setelah tuan/puan memenuhi syarat-syarat kursus yang ditetapkan.
</b><br/>
<?php if($row["k_terms"] != ""){ ?>
Keperluan tambahan kursus : <?php print $row["k_terms"]; ?>
<?php }else{}?>
</td>
</tr>
</table>
...
<tr>
<td>
5.  Sila sahkan penyertaan kursus ini dengan melengkapkan Borang Pengesahan Kehadiran yang disertakan dan emailkan ke koordinator kursus. Sebarang kemusykilan, sila hubungi penyelaras kursus di talian: 
</td>
</tr>
</table>
<!-- Tamat table Para 5  -->
...
<tr>
<td>
Perhatian tuan/puan berhubung perkara ini amat dihargai dan didahului dengan ucapan terima kasih.
</td></tr></table>
<!-- Tamat table Para 6  -->
<br/>
<table width="90%" border="0" align="center">
...
<br />
<br />
<b>*&nbsp; (SILA EMAILKAN KE KOORDINATOR KURSUS PADA ATAU SEBELUM <?php print strtoupper(date('d-m-Y', strtotime($row[k_sdate] . " -7 days"))); ?>)</b></td>
</tr>
</table>
</body>
</html>
