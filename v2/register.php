	...
	<div id="container2">
		...
		if (isset($_SESSION['terai']) && $_SESSION['terai'] == "register") {
			...
			if ($rowCount['total'] == "1") {
				...
				// add parameterized query
				$result = sqlInsert(
					'INSERT INTO user (u_idnum, u_pwd, u_nama, u_jantina, u_dob, u_tel, u_jwt, u_jwttingkat, u_jwtklas, u_jwtgred, u_jwttaraf, u_jkhidmat, u_tkhlantik, u_emel, u_knama, u_kjwt, u_kemel, u_alamatkjab, u_bhgn, u_jab, u_jabaddr1, u_jabaddr2, u_jabpkod, u_jabbandar, u_jabnegeri, u_jabtel, u_jabfax, u_status, u_skop) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
					array(
						$_SESSION['idnum'],
						$pwd,
						$_SESSION['nama'],
		...
		<div id="content">
			...
			<form id="form1" name="form1" method="POST" action="login.php">
				<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
					<tr>
						<td colspan="3" align="center" style="font-weight:bold">MAKLUMAT PEMOHON (Sila Klik Butang HANTAR Untuk Proses Seterusnya)</td>
					</tr>
					<tr>
						<td colspan="3" align="center" style="background-color:#ccc">Maklumat Pemohon <?php echo $_SESSION['tltahun']; ?></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="3" align="center" style="background-color:#ccc">Maklumat Perkhidmatan</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="3" align="center" style="background-color:#ccc">Maklumat Pegawai Yang Meluluskan (Pegawai Penyelia) </td>
					</tr>
					<tr>
						<td align="right">Nama</td>
						<td> : </td>
					...
					<tr>
						<td colspan="3" align="center" style="background-color:#ccc">Maklumat Tempat Bertugas</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2"></td>
						<td><input type="hidden" name="kodrawak" value="<?php print $rawak ?>" maxlength="6" /><input type="text" name="randomkey" value="<?php print $rawak ?>" readonly="true" style="font-family:comic sans ms; font-size:25px; font-style:italic; color:black; border:0;  text-align:center" size="9" disabled></td>
					</tr>
					<tr>
						<td colspan="2"></td>
						<td>Sila taip kembali kod seperti di atas.<br /><input name="vercode" type="text" maxlength="6" placeholder="Code" required /></td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
					</tr>
