...
<div id="project-details">
    ...
    <div class="field">
                    ...
                    <div align="justify"><strong>TUTUP KURSUS: </strong></div>
                   <br>
          ...
          <tr>
            ...
            <td scope="col"><span class="style3">
              <label>
              <input type="hidden" name="idkursus" value="<?php echo $row_uviewkatalog['co_id']; ?>">
			   <input type="hidden" name="idcat" value="<?php echo $row_uviewkatalog['co_catid']; ?>">
              </label>
            </span> </td>
          </tr>
          <tr>
            <td scope="col"><span class="style3"></span></td>
            <td colspan="3" scope="col"><span class="style3"></span><span class="style3">
              <input type="submit" name="closekursus" value="Tutup Kursus">
              <input type="submit" name="padamkursus" value="Padam Kursus">
            </span></td>
            </tr>
      </table>
