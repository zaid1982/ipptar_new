...
<form id="evaluate_form" action="kehadiran_act.php" method="post" >
                    ...
                    <div align="justify"><strong>MAKLUMAT PERMOHONAN NO SIRI: <?php echo $row_serapp['costu_appid']; ?></strong></div>
						...
						<table width="92%" border="0">
                          ...
                          <tr>
                            <td scope="col"><span class="style3"></span></td>
                            <td scope="col"><div align="center" class="style3">
                                <div align="left">No.K.Pengenalan</div>
                            </div></td>
                            <td class="style1" scope="col"><div align="center" class="style3">:</div></td>
                            <td scope="col"><?php echo $row_serall['u_idnum']; ?></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td scope="col"><table width="125" border="0">
                              <tr>
                                <td width="65"><input name="Hadir" type="submit" value="Hadir"></td>
                                <td width="125"><input type="submit" name="Tidak" value="Tidak Hadir"></td>
                              </tr>
                            </table>
                              <label></label>
                            <label></label></td>
