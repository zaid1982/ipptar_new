...
<div id="header">
	...
	<div class="content-area holder">
	  <form id="checklist-options" method="post" action="profiladmin_act.php">
	    ...
	    <table cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="522">
              <input name="adnama" id="Nama" type="text" value="<?php echo $row_viewad['ad_name']; ?>" />            </td>
          </tr>
          <tr>
            <td> </td>
            ...
            <td valign="top">:</td>
            <td>
              <input name="adjawatan" id="Jawatan Dipegang" type="text" value="<?php echo $row_viewad['ad_pos']; ?>" />            </td>
          </tr>
          <tr>
            <td> </td>
            ...
            <td valign="top">:</td>
            <td>
            <input name="adgred" id="Gred Jawatan" type="text" value="<?php echo $row_viewad['ad_gred']; ?>" />            </td>
          </tr>
          <tr>
            <td> </td>
            <td valign="top">Jabatan </td>
            <td valign="top">:</td>
            <td><input name="adjabatan" id="Jabatan" type="text" value="<?php echo $row_viewad['ad_department']; ?>" /></td>
          </tr>
          <tr>
            <td> </td>
            <td valign="top">No. Kad Pengenalan </td>
            <td valign="top">:</td>
            <td><input name="adkp" id="Kad Pengenalan" type="text" value="<?php echo $row_viewad['ad_ic']; ?>" /></td>
          </tr>
          <tr>
            <td> </td>
            ...
            <td valign="top">:</td>
            <td>
              <input name="ademel" type="text" id="Emel" value="<?php echo $row_viewad['ad_email']; ?>" />            </td>
          </tr>
          <tr>
            <td> </td>
            <td valign="top">No. Tel (Pejabat)  </td>
            <td valign="top">:</td>
            <td><input name="adtelhp" id="Tel Pejabat" type="text" value="<?php echo $row_viewad['ad_telhp']; ?>" /></td>
          </tr>
          <tr>
            <td> </td>
            <td valign="top">No. Tel (Bimbit) </td>
            <td valign="top"> :</td>
            <td><input name="adteloff" id="Tel Bimbit" type="text" value="<?php echo $row_viewad['ad_teloff']; ?>" /></td>
          </tr>
          <tr>
            <td> </td>
            <td valign="top">&nbsp;</td>
            <td valign="top">&nbsp;</td>
            <td><label>
              <input name="hiddenadminid" type="hidden" value="<?php echo $row_viewad['ad_id']; ?>" />
            </label></td>
          </tr>
          <tr>
            <td> </td>
            ...
            <td> 
              <label>
              <input name="kemaskiniadmin" type="submit" id="button" onclick="MM_validateForm('Nama','','R','Jawatan Dipegang','','R','Gred Jawatan','','R','Jabatan','','R','Kad Pengenalan','','RinRangeI12:12','Emel','','RisEmail','Tel Pejabat','','RinRangeO9:10','Tel Bimbit','','RinRangeH10:11');return document.MM_returnValue" value="Kemas Kini Profil" />
              </label></td>
          </tr>
          <tr>
            <td> </td>
