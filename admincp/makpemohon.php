	    ...
	    <div id="sort-lists">
		  ...
		  <table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td><form id="form1" name="form1" method="get" action="makpemohon.php">
...
mysql_select_db("$db_name")or die("cannot select DB");
	...
	*/
	...
	/* Get data. */
	 $sql = " select u_id,u_name,u_status,u_idnum from u_profile where u_offaddress!='MAXIMA' order by u_idnum LIMIT $start, $limit";
...
?>
	    ...
	    <table width="92%" border="0">
          <tr>
            ...
            <td width="17%" colspan="3" scope="col"><div align="center" class="style4">Tindakan</div></td>
          </tr>
          <tr>
            <td scope="col">&nbsp;</td>
		 ...
		 <?	while($data=mysql_fetch_array($result)){?>
		  <tr>
            ...
            <td width="16%" scope="col"><div align="center" class="style3"><?=$data['u_idnum'];?></div></td>
            <td width="46%" class="style1" scope="col"><div align="center" class="style3">
              <div align="left"> <?=$data['u_name'];?> </div>
            </div></td>
            <td width="20%" scope="col"><div align="center"><span class="style3"><?=$data['u_status'];?></span></div></td>
            <td colspan="3" valign="top" scope="col"><table width="102" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                 <td valign="top" scope="col"><div align="center"><a href="adviewuser.php?iduser=<?=$data['u_id'];?> & page=1" class="buy" title="Maklumat Pengguna"><img src="lanjut.png" alt="Lihat Maklumat Pengguna" width="37" height="38" border="0" /></a></div></td>
          ...
          <tr>
            ...
            <td colspan="6" scope="col"> <div align="center">
              <?=$pagination?>
              &nbsp;</div></td>
            </tr>
        </table>
...
$tempid=$row_serupro['u_idnum'];
	    ...
	    <table width="80%" border="0">
          <tr>
            <td scope="col">&nbsp;</td>
            <td scope="col"><div align="center" class="style4">No KP </div></td>
            <td scope="col"><div align="center" class="style4">Nama </div></td>
            <td scope="col"><div align="center" class="style4">Status</div></td>
	...
	<? if ($tempid!='') { ?> 
          <tr>
            ...
            <td width="16%" scope="col"><div align="center" class="style3"><?php echo $row_serupro['u_idnum']; ?></div></td>
            <td width="47%" class="style7" scope="col"><div align="center" class="style3">
                <div align="left"><?php echo $row_serupro['u_name']; ?></div>
            </div></td>
            <td width="18%" scope="col"><div align="center"><?php echo $row_serupro['u_status']; ?></div></td>
            <td colspan="3" valign="top" scope="col"><table width="102" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top" scope="col"><div align="center"><a href="adviewuser.php?iduser=<?php echo $row_serupro['u_id']; ?> & page=1" class="buy" title="Maklumat Pengguna"><img src="lanjut.png" alt="Lihat Maklumat Pengguna" width="37" height="38" border="0" /></a></div></td>
