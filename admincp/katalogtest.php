              ...
              <ul style="margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; position: relative; list-style-type: none; z-index: 1; width: 1224px; left: 0px; ">
                ...
                <li class="selectable" title="Bahagian Rancangan Radio" style="overflow-x: hidden; overflow-y: hidden; float: left; width: 147px; height: 61px; "><span class="icon"><a href="katalogtest.php?cat=<? echo 4; ?>" ><img src="mobile-icon.png" alt="Bahagian Rancangan Radio" /></a></span><span class="name">Bahagian Rancangan Radio<span class="field-no">Rancangan</span></span></li>
                 ...
                 <li class="selectable" title="Bahagian Kej Asas Pemancar" style="overflow-x: hidden; overflow-y: hidden; float: left; width: 147px; height: 61px; "><span class="icon"><a href="katalogtest.php?cat=<? echo 5; ?>" ><img src="migrate-icon.png" alt="Bahagian Kej Asas Pemancar" /></a></span><span class="name">Bahagian Kej Asas Pemancar<span class="field-no">Kejuruteraan</span></span></li>
                  ...
                  <li class="selectable" title="Bahagian Pembangunan Teras Dan Pembangunan Rancangan" style="overflow-x: hidden; overflow-y: hidden; float: left; width: 147px; height: 61px; "><span class="icon"><a href="katalogtest.php?cat=<? echo 6; ?>" ><img src="people-icon.png" alt="Bahagian Pembangunan Teras Dan Pembangunan Rancangan" /></a></span><span class="name">Bahagian Pembangunan Teras Dan Pembangunan Rancangan<span class="field-no">Pembangunan</span></span></li>
                  
                  <li class="selectable" title="ICT" style="overflow-x: hidden; overflow-y: hidden; float: left; width: 147px; height: 61px; "><span class="icon"><a href="katalogtest.php?cat=<? echo 7; ?>" ><img src="world-icon.png" alt="ICT" /></a></span><span class="name">ICT<span class="field-no">ICT</span></span></li>
                   
                <li class="selectable" title="Lain-lain" style="overflow-x: hidden; overflow-y: hidden; float: left; width: 147px; height: 61px; "><span class="icon"><a href="katalogtest.php?cat=<? echo 8; ?>" ><img src="mail-icon.png" alt="Lain-lain" /></a></span><span class="name">Lain-lain<span class="field-no">Lain-lain</span></span></li>
...
?>
        ...
        <div id="collaborators">
          ...
          <tr>
            ...
            <td valign="top" scope="col"><div align="center"><a href="mohonkursus.html" class="buy"><img src="padamkursus.png" alt="Lihat Kursus" width="30" height="30" /></a></div></td>
          </tr>	
<?
		}}
	?>
...
?><a href="status.html" class="buy"><img src="document-icon.png" /></a>